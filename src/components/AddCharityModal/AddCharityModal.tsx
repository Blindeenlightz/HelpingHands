...
export const AddCharityModal: React.FC<AddCharityModalProps> = ({
    ...
    return (
        ...
        >
            ...
            <DialogPanel className="bg-[var(--color-cardBackground)] relative mx-auto w-full max-w-md max-h-[90vh] overflow-y-auto rounde p-6 shadow-lg">
                                ...
                                <div className="sm:col-span-full">
                                    ...
                                    <div className="mt-2">
                                        <input
                                            ...
                                            className={`block w-full rounded-md  px-3 py-1.5 text-base  outline-1 outline-gray-300 focus:outline-2 focus:outline-rose-600 sm:text-sm ${
                                                nameError
