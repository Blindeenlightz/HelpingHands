...
export const DonorList: React.FC<DonorListProps> = ({
    ...
    return (
        <Dialog open={open} className="backdrop-blur-sm fixed inset-0 z-50" onClose={onClose}>
            <div className="fixed inset-0 bg-black/30" aria-hidden="true" />

            <div className="fixed inset-0 flex items-center justify-center p-4 ">
                <DialogPanel className="mx-auto max-w-md rounded p-6 shadow-lg bg-[var(--color-cardBackground)]">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            onClick={onClose}
                            className="mx-1.5 cursor-pointer rounded p-1"
                        >
